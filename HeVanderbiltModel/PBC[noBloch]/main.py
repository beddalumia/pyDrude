...
for i in range(7*a,8*a,1):
    ...
    EFcutoff = EF*cutoff
    U0 = 24.674011002723397 # 5*EF for N/L=1 Free Electrons
    U0 = V0*EF
    print('HV step:', U0)
    ...
    Regsum = PBCsConductivity(N,L,eigenEs,eigenCs,EFcutoff)
...
pylab.plot(Length,F, marker='s', c='green', markeredgecolor='black')
pylab.plot(Length,D, marker='o', c='red', markeredgecolor='black')
pylab.plot(Length,R, marker='o', c='orange', markeredgecolor='black')
